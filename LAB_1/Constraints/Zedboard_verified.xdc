...
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {switches_in_0[0]}]
